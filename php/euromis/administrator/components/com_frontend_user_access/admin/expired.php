...
if(defined('_JEXEC')){
	//joomla 1.5
	JToolBarHelper::title( JText::_( 'Frontend User Access' ), 'generic.png' );
}else{
	//joomla 1.0.x
	echo '<table class="adminheading"><tr><th>Frontend User Access</th></tr></table>';
}	
...
<p><a href="http://www.pages-and-items.com/shop" target="_blank">purchase Frontend-User-Access</a>.</p>
<p>
...
//footer
echo '<div class="smallgrey" id="ua_footer"><a href="http://www.pages-and-items.com/frontend-user-access" target="_blank">Frontend-User-Access</a> &copy;</div>';
