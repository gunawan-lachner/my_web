...
class ConfigMagik{
	...
	*/
	function save( $path=null){
        ...
        $content .= "; This files was automagically generated by EuroMIS\n";
        $content .= "; If you're not know what you're doing, do not edit this file by hand, use EuroMIS instead.\n";
        $content .= "; Last modified: ".date('d M Y H:i s')."\n";
