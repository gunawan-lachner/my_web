...
$(document).ready(function()
{
	...
	// Updated By: Gunawan. 24 March 2015. Add Non Atm Transaction Info
    $('#nonatm_transaction_info').load('<?php echo ROOT_FOLDER."/".$script_folder."/".$script_helper_name; ?>', {t: 12, row: row_itm_node});
...
<div id="columns">
        ...
        <ul id="column1" class="column">
            ...
            <li class="widget color-green">
                <div class="widget-head">
                    <h3>Non ATM Transaction Info</h3>
                </div>
                <div class="widget-content">
                    <div id="nonatm_transaction_info"></div>
                </div>
            </li>
        </ul>
