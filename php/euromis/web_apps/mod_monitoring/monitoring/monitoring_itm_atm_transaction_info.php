...
$SQL           = "SELECT COUNT(*) FROM ZTRANS_VIEW WITH (NOLOCK) WHERE _TDATTM BETWEEN '$current_date 00:00:00.000' AND '$current_date 23:59:59.000' AND CCOD = '360' AND TRAQPT = 'SCB' AND TRRSPC = '00'";
...
$SQL           = "SELECT COUNT(*) FROM ZTRANS_VIEW WITH (NOLOCK) WHERE _TDATTM BETWEEN '$current_date 00:00:00.000' AND '$current_date 23:59:59.000' AND CCOD = '360' AND TRAQPT = 'BTP' AND TRRSPC = '08'";
$result_BTP_08 = odbc_exec( $CONNECTION, $SQL ) or $euromis->fn_error_log( ERROR_ON_QUERY . ' : ' . odbc_error() . '-' . odbc_errormsg() . ' : ' . $SQL );

odbc_fetch_row( $result_BTP_08 );
$BTP_08        = odbc_result($result_BTP_08, 1);

$SQL           = "SELECT COUNT(*) FROM ZTRANS_VIEW WITH (NOLOCK) WHERE _TDATTM BETWEEN '$current_date 00:00:00.000' AND '$current_date 23:59:59.000' AND CCOD = '360' AND TRAQPT = 'BTP' AND TRRSPC = '10'";
$result_BTP_10 = odbc_exec( $CONNECTION, $SQL ) or $euromis->fn_error_log( ERROR_ON_QUERY . ' : ' . odbc_error() . '-' . odbc_errormsg() . ' : ' . $SQL );

odbc_fetch_row( $result_BTP_10 );
$BTP_10        = odbc_result($result_BTP_10, 1);

$SQL           = "SELECT COUNT(*) FROM ZTRANS_VIEW WITH (NOLOCK) WHERE _TDATTM BETWEEN '$current_date 00:00:00.000' AND '$current_date 23:59:59.000' AND CCOD = '360' AND TRAQPT = 'BTP' AND TRRSPC = '99'";
$result_BTP_99 = odbc_exec( $CONNECTION, $SQL ) or $euromis->fn_error_log( ERROR_ON_QUERY . ' : ' . odbc_error() . '-' . odbc_errormsg() . ' : ' . $SQL );

odbc_fetch_row( $result_BTP_99 );
$BTP_99        = odbc_result($result_BTP_99, 1);

$SQL           = "SELECT COUNT(*) FROM ZTRANS_VIEW WITH (NOLOCK) WHERE _TDATTM BETWEEN '$current_date 00:00:00.000' AND '$current_date 23:59:59.000' AND CCOD = '360' AND TRAQPT = 'BTP' AND TRRSPC NOT IN ('00', '08', '10', '99', '61')";
$result_BTP    = odbc_exec( $CONNECTION, $SQL ) or $euromis->fn_error_log( ERROR_ON_QUERY . ' : ' . odbc_error() . '-' . odbc_errormsg() . ' : ' . $SQL );

odbc_fetch_row( $result_BTP );
$BTP_OTHER     = odbc_result($result_BTP, 1);
...
<tr id="table_monitoring_header">
<td colspan="3">ATM Transaction Status Failed for BTPN</td>
</tr>

<tr>
<td width="200">RC 08</td>
<td width="3">:</td>
<td><strong><?php echo $BTP_08; ?></strong></td>
</tr>

<tr>
<td>RC 10</td>
<td>:</td>
<td><strong><?php echo $BTP_10; ?></strong></td>
</tr>

<tr>
<td>RC 99</td>
<td>:</td>
<td><strong><?php echo $BTP_99; ?></strong></td>
</tr>

<tr>
<td>RC Failed Other</td>
<td>:</td>
<td><strong><?php echo $BTP_OTHER; ?></strong></td>
</tr>
