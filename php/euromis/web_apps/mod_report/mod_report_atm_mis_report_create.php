...
{               
    ...
    $bank_member_format = array(
                            "SCB"=>array("Blank Node", "BER", "CCB", "GID", "SCB", "VPS"), 
                            "BTP"=>array("Blank Node", "BE0", "BTP")
                        );
    ...
    # Force download
    $euromis->fn_outputFile( $fileTemp, "$bank_id_ATM_MIS_REPORT_".$date_from."_".$date_to.".xls" );            
