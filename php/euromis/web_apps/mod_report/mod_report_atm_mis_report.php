...
$script_name        = "mod_report_atm_mis_report.php";
$script_helper_name = "mod_report_atm_mis_report_create.php";

$BANK_MEMBER        = array("SCB", "BTPN");
...
<div id="page_title"><?php echo PAGE_TITLE_8; ?></div>
...
<tr align="left">
<td width="100" colspan="4"><strong>Card Embossing File and Pin Production</strong></td><td>:</td><td><input type="text" name="emboss" id="emboss" size="2"></td>
</tr>
