...
$script_name        = "mod_report_recharge_user_history.php";
$script_helper_name = "mod_report_recharge_user_history_create.php";
...
<div id="page_title"><?php echo PAGE_TITLE_3; ?></div>
...
<td width="100"><strong>No. MSISDN</strong></td><td width="3">:</td>
<td><input type="text" id="msisdn" name="msisdn"></td>

</tr>

<tr>      
<td align="center" colspan="4">
Please be patience because query the data need time ( max 360 seconds )
</td>
</tr>
