...
$script_name        = "mod_tools_mr_node.php";
$script_helper_name = "mod_tools_mr_node_helper.php";
...
<div id="page_title"><?php echo PAGE_TITLE_15; ?></div>
...
$(document).ready(function(){
    ...
    $('#progress_bar').hide();    
      ...
      $("#list").jqGrid({
          ...
          colModel:[                                                                                                                           
              {name: 'E_DATE',        index: 'E_DATE',        width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},              
              {name: 'E_TIME',        index: 'E_TIME',        width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},              
              {name: 'E_NODE',        index: 'E_NODE',        width: 75,  align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},
              {name: 'E_DESCRIPTION', index: 'E_DESCRIPTION', width: 250, align: 'left',   editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},
              {name: 'E_STATUS',      index: 'E_STATUS',      width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}} ],
          rowNum: 30,
          rowList: [10,20,30,50,100],
          pager: '#pager',
          sortname: 'E_DATE DESC, E_TIME',
          viewrecords: true,
          rownumbers: true, 
          rownumWidth: 30,               
          sortorder: "desc",
          caption: 'AS400 MR Node History Log',
          mtype: 'POST',       
