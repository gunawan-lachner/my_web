...
$script_name        = "mod_tools_mr_module.php";
$script_helper_name = "mod_tools_mr_module_helper.php";
...
<div id="page_title"><?php echo PAGE_TITLE_14; ?></div>
...
$(document).ready(function(){
    ...
    $('#progress_bar').hide();    
      ...
      $("#list").jqGrid({
          ...
          datatype: "xml",
          colNames:['Date','Time','Module','Description','Status'],
          colModel:[                                                                                                                           
              {name: 'F_DATE',        index: 'F_DATE',        width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},              
              {name: 'F_TIME',        index: 'F_TIME',        width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},              
              {name: 'F_MODULE',      index: 'F_MODULE',      width: 75,  align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},
              {name: 'F_DESCRIPTION', index: 'F_DESCRIPTION', width: 250, align: 'left',   editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},
              {name: 'F_STATUS',      index: 'F_STATUS',      width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}} ],
          rowNum: 30,
          rowList: [10,20,30,50,100],
          pager: '#pager',
          sortname: 'F_DATE DESC, F_TIME',
          viewrecords: true,
          rownumbers: true, 
          rownumWidth: 30,               
          sortorder: "desc",
          caption: 'AS400 MR Module History Log',
          mtype: 'POST',       
