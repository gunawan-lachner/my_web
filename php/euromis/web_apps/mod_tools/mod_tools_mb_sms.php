...
$script_name        = "mod_tools_mb_sms.php";
$script_helper_name = "mod_tools_mb_sms_helper.php";
...
<div id="page_title"><?php echo PAGE_TITLE_6; ?></div>
...
$(document).ready(function(){
    ...
    $('#progress_bar').hide();    
      ...
      $("#list").jqGrid({
          ...
          datatype: "xml",
          colNames:['Date Time','Date','Time','Originator','Destination','Channel','SMS Message','Status'],
          colModel:[                                                                                                                           
              {name: 'C_TIMESTAMP',   index: 'C_TIMESTAMP',   width: 200, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true},            editrules: {edithidden: true}, search: false},
              {name: 'C_DATE',        index: 'C_DATE',        width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},              
              {name: 'C_TIME',        index: 'C_TIME',        width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},              
              {name: 'C_ORIGINATOR',  index: 'C_ORIGINATOR',  width: 150, align: 'left',   editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true},            editrules: {edithidden: true}},
              {name: 'C_DESTINATION', index: 'C_DESTINATION', width: 150, align: 'left',   editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},
              {name: 'C_CHANNEL',     index: 'C_CHANNEL',     width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},
              {name: 'C_BODYXML',     index: 'C_BODYXML',     width: 200, align: 'left',   editable: true, edittype: 'textarea', editoptions: {rows:'4', cols:'50', readonly: true}, editrules: {edithidden: true}},  
              {name: 'C_STATUS',      index: 'C_STATUS',      width: 50,  align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true},            editrules: {edithidden: true}} ],  
          rowNum: 30,
          rowList: [10,20,30,50,100],
          pager: '#pager',
          sortname: 'C_TIMESTAMP',
          viewrecords: true,
          rownumbers: true, 
          rownumWidth: 30,               
          sortorder: "desc",
          caption: 'Mobile Recharge SMS Log',
          mtype: 'POST',       
