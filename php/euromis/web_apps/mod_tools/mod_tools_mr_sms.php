...
$script_name        = "mod_tools_mr_sms.php";
$script_helper_name = "mod_tools_mr_sms_helper.php";
...
<div id="page_title"><?php echo PAGE_TITLE_5; ?></div>
...
$(document).ready(function(){
    ...
    $('#progress_bar').hide();    
      ...
      $("#list").jqGrid({
          ...
          colModel:[                                                                                                                           
              {name: 'B_TIMESTAMP',   index: 'B_TIMESTAMP',   width: 200, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true},            editrules: {edithidden: true}, search: false},
              {name: 'B_DATE',        index: 'B_DATE',        width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},              
              {name: 'B_TIME',        index: 'B_TIME',        width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},              
              {name: 'B_ORIGINATOR',  index: 'B_ORIGINATOR',  width: 150, align: 'left',   editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true},            editrules: {edithidden: true}},
              {name: 'B_DESTINATION', index: 'B_DESTINATION', width: 150, align: 'left',   editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},
              {name: 'B_CHANNEL',     index: 'B_CHANNEL',     width: 100, align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true}},
              {name: 'B_BODYXML',     index: 'B_BODYXML',     width: 200, align: 'left',   editable: true, edittype: 'textarea', editoptions: {rows:'4', cols:'50', readonly: true}, editrules: {edithidden: true}},  
              {name: 'B_STATUS',      index: 'B_STATUS',      width: 50,  align: 'center', editable: true, edittype: 'text',     editoptions: {size: 50, readonly: true},            editrules: {edithidden: true}} ],  
          rowNum: 30,
          rowList: [10,20,30,50,100],
          pager: '#pager',
          sortname: 'B_TIMESTAMP',
          viewrecords: true,
          rownumbers: true, 
          rownumWidth: 30,               
          sortorder: "desc",
